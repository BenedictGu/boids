...
#  
#   add_body: adds a Body object to the system to be simulated
#   add_system: adds a collection of bodies to the system
#   remove_body: removes a Body object from the simulated system
...
#   draw_shape: used by 'render' to depict a body. Uses each body's
...
# interaction---the method 'pointer' (using 'window_to_world' 
